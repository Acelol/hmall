...
import com.hmall.api.client.IOrderClient;
import com.hmall.api.client.IUserClient;
...
public class PayOrderServiceImpl extends ServiceImpl<PayOrderMapper, PayOrder> implements IPayOrderService {
    ...
    public void tryPayOrderByBalance(PayOrderFormDTO payOrderFormDTO) {
        ...
        // 3.尝试扣减余额
        iUserClient.deductMoney(payOrderFormDTO.getPw(), po.getAmount());
        // 4.修改支付单状态
...
//        }catch (Exception e){
//            log.error("send msg failed id :{}", po.getBizOrderNo());
//        }
//        iOrderClient.markOrderPaySuccess(po.getBizOrderNo());
    }
